...
SELECT *FROM students ORDER BY s_name ASC LIMIT 3 ;

UPDATE students SET s_age = 20, s_course ='BTECH(IT)' WHERE id =1110;

DELETE FROM students WHERE id=1101;

SELECT COUNT(*) FROM students;

SELECT s_course,COUNT(s_name) FROM students GROUP BY s_course; 

SELECT *FROM students ORDER BY s_age DESC LIMIT 1;

SELECT *FROM students ORDER BY s_age ASC LIMIT 1;
